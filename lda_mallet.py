...
if __name__ == '__main__':
    ...
    sent_topics_sorteddf_mallet.to_csv('output.csv', sep='\t', encoding='utf-8')
    dataframe_to_file(sent_topics_sorteddf_mallet)
    '''

    parsed_data = get_all_data(output_folder)
    i = 0
    for file in parsed_data:
        print(str(i) + " : " + file['kewords'])
        if i==22:
            print(file['text'])
        i+=1
